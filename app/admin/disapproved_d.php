...
?>
	<section id="main" class="column">	
		...
		if ($done == '0')
		{echo '<h4 class="alert_success" style="display:block">USER was Pushed to the "New" list!</h4>';}
		if ($done == '1')
			...
			<header><h3><?php echo $row['name'];?> Has Got <?php echo $row['votes'];?> Vote(s)</h3></header>
				<div class="module_content">
                        ...
                        <tr><td align="center" colspan="3">
                            ...
                            <tr><td valign="top"><b>Picture:</b></td><Td>&nbsp;&nbsp;</Td><td><a href="../<?php echo $row['image'];?>" class="fancybox" rel="group"><img src="../<?php echo $row['image'];?>"></a></td></tr>
				...
				<div class="submit_link">
					<form method="post" action="disapproved_d.php?user=<?php echo $user;?>">
					<input type="submit" value="Approved" name="approve" id="submit_answer" class="alt_btn">
					<input type="submit" value="New" name="waiting">
                    </form>
				</div>
