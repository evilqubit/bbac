...
$myapp = "https://www.facebook.com/bbacbank?&sk=app_597766673589432";
$error = '';
$success = '';
?>
...
<body>
	...
	<aside id="sidebar" class="column">
        ...
        <h3>Card Requests</h3>
		<ul class="toggle">
            <li class="icn_photo"><a href="card.php">New</a></li>
            <li class="icn_photo"><a href="c_approved.php">Approved</a></li>
            <li class="icn_photo"><a href="c_disapproved.php">Disapproved</a></li>
		</ul>	
        <h3>Voting</h3>
		<ul class="toggle">
