...
$dbs = "SELECT * FROM afcard WHERE status = '2'";
$extractx = mysql_query ($dbs);
$numrows = mysql_num_rows ($extractx);


$db = "SELECT * FROM afcard WHERE status = '2' ORDER BY id DESC LIMIT $i, 50";
...
?>
		...
		<div class="tab_container">
			...
			?>
				<tr>
    				...
    				<td><input onClick="window.location='c_disapproved_d.php?user=<?php echo $row['id'];?>'" type="image" src="images/icn_edit.png" title="Details">
                    
                    <form method="post" action="c_disapproved.php">
	...
	if ($y == 1)
	{
		...
		while ( ($count < $lim) && ($y < $x) )
		{
			...
			$y += 1;
			$count += 1;?>
		<form name="poll_page" action="c_disapproved.php" method="post">
